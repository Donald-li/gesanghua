...
Project.find_or_create_by(name: '悦读补书', protocol: content, describe: description, kind: 'book', fund: fc2.funds.unrestricted.first, appoint_fund: fc2.funds.restricted.first)
...
Project.find_or_create_by(name: '护花课程', protocol: content, describe: description, kind: 'movie', fund: fc3.funds.unrestricted.first, appoint_fund: fc3.funds.restricted.first)
