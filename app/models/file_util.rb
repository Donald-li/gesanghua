...
class FileUtil
  ...
  def self.import_pair_students(original_filename: nil, path: nil, project_apply: nil)
    ...
    2.upto(s.last_row) do |line|
      ...
      classname = s.formatted_value(line, 'H')
      teacher_name = s.formatted_value(line, 'I')
      teacher_phone = s.formatted_value(line, 'J')
      description = s.formatted_value(line, 'K')
      father = s.formatted_value(line, 'L')
      father_job = s.formatted_value(line, 'M')
      mother = s.formatted_value(line, 'N')
      mother_job = s.formatted_value(line, 'O')
      parent_information = s.formatted_value(line, 'P')
      guardian = s.formatted_value(line, 'Q')
      guardian_relation = s.formatted_value(line, 'R')
      guardian_phone = s.formatted_value(line, 'S')
      address = s.formatted_value(line, 'T')
      family_income = s.formatted_value(line, 'U')
      income_source = s.formatted_value(line, 'V')
      family_expenditure = s.formatted_value(line, 'W')
      expenditure_information = s.formatted_value(line, 'X')
