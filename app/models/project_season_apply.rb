...
class ProjectSeasonApply < ApplicationRecord
  ...
  enum execute_state: {raising: 1, execute: 2, receive: 3, feedback: 4, done: 5}#执行状态 1:筹款中 2:待执行 3:待收货 4:待反馈 5:已完成

  enum fundraising_state: {outside_raising: 1, no_raising: 2}#对外筹款状态 1:对外筹款 2:不对外筹款
