    ...
    function h(b, f) {
      ...
      var a = function() {
        ...
        d = {
          ...
          mod: function(y) {
            if (0 >
              d.getLength() - y.getLength()) return d;
      ...
      var a = f[c],
        ...
        B = function(A, f) {
          ...
          if (7 <= b) {
            ...
            for (l = 0; 18 > l; l +=
              1) c = !A && 1 == (r >> l & 1), d[Math.floor(l / 3)][l % 3 + y - 8 - 3] = c;
    ...
    var f = {
      ...
      n = function() {
        ...
        m.getLostPoint = function(d) {
          ...
          for (c = 0; c < a; c += 1)
            for (e = 0; e < a - 6; e += 1) d.isDark(e, c) && !d.isDark(e + 1, c) && d.isDark(e + 2, c) && d.isDark(e + 3, c) && d.isDark(e + 4, c) && !d.isDark(e + 5, c) && d.isDark(e + 6,
              c) && (b += 40);
          for (c = m = 0; c < a; c += 1)
        ...
        return {
          read: function() {
            for (; 8 > d;) {
              ...
              c += 1;
              if ("=" == g) return d = 0, -1;
              g.match(/^\s$/) || (a = a << 6 | f(g.charCodeAt(0)),
                d += 6)
            }
            g = a >>> d - 8 & 255;
            d -= 8;
      ...
      D = function(b, c, a, d) {
        for (var f = z(b, c), g = 0; g < c; g += 1)
          for (var e =
              0; e < b; e += 1) f.setPixel(e, g, a(e, g));
        a = x();
        f.write(a);
        f = w();
        a = a.toByteArray();
