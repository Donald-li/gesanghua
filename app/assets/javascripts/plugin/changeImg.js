(function($){
	$.fn.changeImg=function(options){
		...
		var _html='<a href="javascript:;" class="change-bnt prev-bnt"><span class="iconfont icon-arrowdown bu-icon-prev"></span></a><a href="javascript:;" class="change-bnt next-bnt"><span class="iconfont icon-arrowdown bu-icon-next"></span></a>';
