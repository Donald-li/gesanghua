!function (r) {
    ...
    function d(r) {
      ...
      // return p("<img />").attr("src", "/assets/wechat-qrcode-faac1e2749fcb627d94cf6950d0a27d60be7dbb5b1f25d0ed5e168392d5ce852.png")
    }
    ...
    r.fn.share = function (t) {
        ...
        function n(r, t) {
            ...
            e.length && (e.append('<div class="wechat-qrcode"><div class="qrcode"></div><div class="help">' + t.wechatQrcodeHelper + "</div></div>"), e.find(".qrcode").qrcode({
                render: "canvas",
        ...
        var f = r(document.head), c = {
            ...
            weiboKey: "",
            wechatQrcodeHelper: "<p>微信扫描二维码</p><p>可将文章分享至朋友圈</p>",
            wechatQrcodeSize: 1000,
            mobileSites: [],
