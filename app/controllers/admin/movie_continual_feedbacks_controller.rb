class Admin::MovieContinualFeedbacksController < Admin::BaseController
  ...
  def create
    @continual = ContinualFeedback.new(continual_params.merge(owner_type: 'Project', project_id: Project.movie_project.id))
  ...
  def update
    respond_to do |format|
      if @continual.update(continual_params.merge(owner_type: 'Project', project_id: Project.movie_project.id))
