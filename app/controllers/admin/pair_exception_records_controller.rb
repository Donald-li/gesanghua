class Admin::PairExceptionRecordsController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @exception_record.save
        ...
        format.html {redirect_to referer_or(admin_pair_applies_path), notice: '新增成功。'}
      else
  ...
  def set_project_apply
    @apply = ProjectSeasonApply.find(params[:pair_apply_id])
  end
end
