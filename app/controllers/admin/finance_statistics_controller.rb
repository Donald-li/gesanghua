class Admin::FinanceStatisticsController < Admin::BaseController
  ...
  def show
    ...
    income_records = IncomeRecord.left_joins(:agent).select("income_no as finance_no, title, fund_id, income_time as finance_time, amount as income_amount, 0 as expend_amount, income_source_id, users.name as operator, income_records.remark")
