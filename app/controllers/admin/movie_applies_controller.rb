class Admin::MovieAppliesController < Admin::BaseController
  ...
  def index
    ...
    scope = @search.result.includes(:school)
  ...
  def create
    ...
    respond_to do |format|
      if ProjectSeasonApply.find_by(school_id: project_apply_params[:school_id], project_season_id: project_apply_params[:project_season_id], project_id: Project.movie_project.id).present?
