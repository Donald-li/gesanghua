...
class Admin::AuditsController < Admin::BaseController
  ...
  def index
    ...
    'ProjectSeasonApplyBookshelf', 'BookshelfSupplement', 'Camp', 'CampDocumentEstimate', 'CampDocumentFinance', 'CampDocumentVolunteer', 'CampDocumentSummary', 'CampProjectResource', 'Volunteer', 'Campaign', 'CampaignEnlist']).
