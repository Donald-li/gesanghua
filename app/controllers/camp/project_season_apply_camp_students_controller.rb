class Camp::ProjectSeasonApplyCampStudentsController < Camp::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @camp_student.save
        ...
        format.html { redirect_to camp_project_season_apply_camp_students_path(apply_camp_id: @apply_camp.id), notice: '新增成功。' }
      else
  ...
  def update
    respond_to do |format|
      if @camp_student.update(camp_student_params)
        @camp_student.attach_image(params[:image_id])
        format.html { redirect_to camp_project_season_apply_camp_students_path(apply_camp_id: @apply_camp.id), notice: '修改成功。' }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to camp_project_season_apply_camp_students_path(apply_camp_id: @apply_camp.id), notice: '删除成功。' }
    end
  end
  ...
  def check
    respond_to do |format|
      ...
      if @camp_student.save
        ...
        format.html { redirect_to camp_project_season_apply_camp_students_path(apply_camp_id: @apply_camp.id), notice: '审核成功' }
      else
