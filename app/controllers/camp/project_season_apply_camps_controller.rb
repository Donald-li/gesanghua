class Camp::ProjectSeasonApplyCampsController < Camp::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @apply_camp.save
        format.html { redirect_to camp_project_project_season_apply_camps_path, notice: '新增成功。' }
      else
  ...
  def update
    respond_to do |format|
      if @apply_camp.update(apply_camp_params)
        format.html { redirect_to camp_project_project_season_apply_camps_path, notice: '修改成功。' }
      else
  ...
  def destroy
    @apply_camp.destroy
    respond_to do |format|
      format.html { redirect_to camp_project_project_season_apply_camps_path, notice: '删除成功。' }
    end
  end
  ...
  def switch
    ...
    respond_to do |format|
      if @apply_camp.save
        format.html { redirect_to camp_project_project_season_apply_camps_path, notice: '标记成功。' }
      else
        format.html { redirect_to camp_project_project_season_apply_camps_path, notice: '标记失败。' }
      end
    end
  end
  ...
  def set_apply
    @apply = ProjectSeasonApply.find(params[:project_id])
  end
