class Api::V1::PairChildrenController < Api::V1::BaseController
  ...
  def settlement
    ...
    grants.each do |grant|
      record = DonateRecord.find_or_create_by(user: current_user, fund: @pair.project.fund, amount: grant[:amount].to_f, project: @pair.project, team: team, donor: params[:donor], remitter_id: current_user.id, remitter_name: current_user.name, season: @pair.season, apply: @pair.apply, project_season_apply_child: @pair)
