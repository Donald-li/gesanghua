class Api::V1::CooperationChecksController < Api::V1::BaseController
  ...
  def identity_user_info
    ...
    if params[:check_role] === 'teacher'
      if @teacher = Teacher.find_by(phone: params[:phone])
      ...
      if @school = School.find_by(contact_phone: params[:phone])
      ...
      if @county_user = CountyUser.find_by(phone: params[:phone])
      ...
      if @gsh_child = GshChild.find_by(phone: params[:phone])
      ...
      if @volunteer = Volunteer.find_by(phone: params[:phone])
