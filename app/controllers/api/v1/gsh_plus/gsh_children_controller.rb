class Api::V1::GshPlus::GshChildrenController < Api::V1::BaseController
  ...
  def confirm_identity
    ...
    api_success(data: {pair_records: pair_records.map{|record| record.pair_record_builder}, camp_records: camp_records.map{|record| record.apply.try(:name)}, child_info: pair_records.first.try(:child_info_builder)})
  end
