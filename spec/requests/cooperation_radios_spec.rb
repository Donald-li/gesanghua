...
RSpec.describe "Api::V1::CooperationRadios", tye: :request do
  ...
  describe '测试协作平台-广播项目管理' do
    it '广播项目列表' do
      get api_v1_cooperation_radios_path, headers: api_v1_headers(login_user)
    ...
    it '查看广播申请' do
      get api_v1_cooperation_radio_path(id: apply.id), headers: api_v1_headers(login_user)
      api_v1_expect_success
    ...
    it '待新增广播申请' do
      get new_api_v1_cooperation_radio_path, headers: api_v1_headers(login_user)
      api_v1_expect_success
      expect(json_body[:data][:school][:id]).to eq school.id
    ...
    it '创建广播申请' do
      post api_v1_cooperation_radios_path,
          params: {radio_apply: {season:[season.id], student_number: '30', describe: FFaker::LoremCN.sentence,
    ...
    it '修改广播申请' do
      patch api_v1_cooperation_radio_path(id: apply.id),
           params: {radio_apply: {season:[season.id], student_number: '30', describe: FFaker::LoremCN.sentence,
                                 contact_name: FFaker::NameCN.name, contact_phone: '17888889999', location: [110000, 110100, 110101], address: '某街'}},
           headers: api_v1_headers(login_user)
      api_v1_expect_success
